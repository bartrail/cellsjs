...
(function() {
  ...
  class Game {
    ...
    constructor() {
      ...
      this.energyStage.visible = false;
      this.mainStage.addChild(this.energyStage, this.terrainStage);
    ...
    showTerrain(visible) {
      this.terrainStage.visible = visible;
    }

    showEnergy(visible) {
      this.terrainStage.visible = !visible;
      this.energyStage.visible = visible;
    }
